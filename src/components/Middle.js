  ...
  return (
    <div className="flex flex-col mt-10">
      <div className="grid  sm:grid-flow-col auto-cols-max items-center gap-3">
        <GoHome
          ...
          className={`text-gray-500 cursor-pointer ${
            activeItem === "Home" ? "text-blue-900" : ""
          }`}
          onClick={() => handleClick("Home")}
        />
        <MdKeyboardArrowRight
          size={"25px"}
          className="text-[#06286E] hidden sm:flex"
        />
        <MdKeyboardArrowDown
          size={"25px"}
          className="text-[#06286E] sm:hidden"
        />
        <p
          className={`text-[#696671] font-medium text-lg cursor-pointer ${
            activeItem === "Flashcard" ? "text-blue-900" : ""
          }`}
        ...
        <p
          className={`text-[#696671] font-medium text-lg cursor-pointer ${
            activeItem === "Mathematics" ? "text-blue-900" : ""
          }`}
        ...
        <p
          className={`text-[#696671] font-medium text-lg cursor-pointer ${
            activeItem === "Relation and Function" ? "text-blue-900" : ""
          }`}
          onClick={() => handleClick("Relation and Function")}
        >
      ...
      <p
        ...
        className="font-bold text-2xl mt-14"
      >
      ...
      <div className="flex flex-col w-[100%] lg:w-[712px] h-[full] justify-center items-center mx-auto gap-5 mt-10">
        ...
        <div
          className="w-full h-[393.19px] rounded-3xl"
          style={{
            background:
        ...
        >
          ...
          <p className="mt-[150px] text-center font-bold text-xl sm:text-3xl text-white">
            9 + 6 + 7x - 2x - 3
          </p>
        </div>
        ...
        <div className="flex justify-between items-center w-[90%]">
          ...
          <div className="flex justify-between items-center gap-2 sm:gap-8">
            <img
              src={Left}
              alt="Left"
              className="w-[20px] sm:w-[60px]  cursor-pointer"
            />
            <p className="text-[#202B37] font-bold text-sm sm:text-2xl">
              01/10
            </p>
            <img
              src={Right}
      ...
      <div className="sm:flex justify-between items-center mt-8">
        <img
          src={Hyggex}
          alt="Hyggex"
          className=" w-[150px] sm:w-[217px] -ml-5 sm:-ml-8"
        />
